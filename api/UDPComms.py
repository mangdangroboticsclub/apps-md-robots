#
# Description: This is a simple library to enable communication between different processes (potentially on different machines) 
# over a network using UDP. It's goals a simplicity and easy of understanding and reliability
...
if __name__ == "__main__":
    ...
    #a = Publisher(8840, "127.0.0.1")
    a = Publisher(8830, "127.0.0.1")
    a.send( {
        "L1": True,
        "R1": False,
        "L2": -1.0,
